...
<div class="pad50" >
	<div id="oj">
		<p class="problem">
			<iframe src="http://poj.org/problem?id={{$pid}}" width="100%" height="700px" frameborder="0" id="pro"></iframe>
		</p>
	</div>
	
	<button class="btn btn-info" style="text-align: center;margin: 0 auto;" id="copy" data-clipboard-target="ac">复制题解代码</button>
	<div id="tishi">
	</div>
	<div class="code">
	...
	<!-- 多说评论框 start -->
	<div class="ds-thread" data-thread-key="" data-title="IOJ-poj{{$pid}}" data-url="http://www.jtahstu.com/ioj/public/poj/pid/{{$pid}}">
	</div>
	<!-- 多说评论框 end -->
